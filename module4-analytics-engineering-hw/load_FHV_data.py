...
BUCKET_NAME = "module4-homework"

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = "../module2-homework/service-account.json"
...
def download_file(month):
    ...
    try:
        ...
        # df=pd.read_csv(f"green_tripdata_2019-{month}.csv.gz")
        # df.to_parquet(f"green_tripdata_2019-{month}.parquet")
        file_path = os.path.join(DOWNLOAD_DIR, f"fhv_tripdata_2019-{month}.csv.gz")
